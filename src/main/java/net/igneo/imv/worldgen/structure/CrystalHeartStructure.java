...
public class CrystalHeartStructure extends Structure {
    public static final Codec<CrystalHeartStructure> CODEC = RecordCodecBuilder.<CrystalHeartStructure>mapCodec(instance ->
            instance.group(CrystalHeartStructure.settingsCodec(instance),
            ...
            ).apply(instance, CrystalHeartStructure::new)).codec();
    ...
    public CrystalHeartStructure(StructureSettings config,
    ...
    public StructureType<?> type() {
        return ModStructures.CRYSTAL_HEART.get();
    }
}
