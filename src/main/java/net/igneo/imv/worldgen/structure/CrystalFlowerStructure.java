...
public class CrystalFlowerStructure extends Structure {
    public static final Codec<CrystalFlowerStructure> CODEC = RecordCodecBuilder.<CrystalFlowerStructure>mapCodec(instance ->
            instance.group(CrystalFlowerStructure.settingsCodec(instance),
            ...
            ).apply(instance, CrystalFlowerStructure::new)).codec();
    ...
    public CrystalFlowerStructure(StructureSettings config,
    ...
    public Optional<GenerationStub> findGenerationPoint(GenerationContext pContext) {
        ...
        int fz = pos2.getZ();
        while (searching) {
            if ((blockReader.getBlock(pos2.getY() + 5).is(BlockTags.REPLACEABLE) && blockReader.getBlock(pos2.getY() + 1).is(BlockTags.REPLACEABLE) && !blockReader.getBlock(pos2.getY() - 1).is(BlockTags.REPLACEABLE))) {
    ...
    public StructureType<?> type() {
        return ModStructures.CRYSTAL_FLOWER.get();
    }
}
