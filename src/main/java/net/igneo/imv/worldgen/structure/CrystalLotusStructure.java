...
public class CrystalLotusStructure extends Structure {
    public static final Codec<CrystalLotusStructure> CODEC = RecordCodecBuilder.<CrystalLotusStructure>mapCodec(instance ->
            instance.group(CrystalLotusStructure.settingsCodec(instance),
            ...
            ).apply(instance, CrystalLotusStructure::new)).codec();
    ...
    public CrystalLotusStructure(StructureSettings config,
    ...
    public StructureType<?> type() {
        return ModStructures.CRYSTAL_LOTUS.get();
    }
}
