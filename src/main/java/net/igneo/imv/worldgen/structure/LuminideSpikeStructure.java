...
public class LuminideSpikeStructure extends Structure {
    public static final Codec<LuminideSpikeStructure> CODEC = RecordCodecBuilder.<LuminideSpikeStructure>mapCodec(instance ->
            instance.group(LuminideSpikeStructure.settingsCodec(instance),
            ...
            ).apply(instance, LuminideSpikeStructure::new)).codec();
    ...
    public LuminideSpikeStructure(StructureSettings config,
    ...
    public StructureType<?> type() {
        return ModStructures.LUMINIDE_SPIKE.get();
    }
}
