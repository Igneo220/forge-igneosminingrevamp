...
public class ValueniteClusterConfiguration implements FeatureConfiguration {
    public static final Codec<ValueniteClusterConfiguration> CODEC = RecordCodecBuilder.create((codec) -> {
        return codec.group(Codec.intRange(1, 512).fieldOf("floor_to_ceiling_search_range").forGetter((p_160806_) -> {
        ...
        })).apply(codec, ValueniteClusterConfiguration::new);
    });
    ...
    public ValueniteClusterConfiguration(int p_160772_, IntProvider p_160773_, IntProvider p_160774_, int p_160775_, int p_160776_, IntProvider p_160777_, FloatProvider p_160778_, FloatProvider p_160779_, float p_160780_, int p_160781_, int p_160782_) {
