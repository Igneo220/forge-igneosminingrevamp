...
public class HuestoneClusterConfiguration implements FeatureConfiguration {
    public static final Codec<HuestoneClusterConfiguration> CODEC = RecordCodecBuilder.create((codec) -> {
        ...
        })).apply(codec, HuestoneClusterConfiguration::new);
    });
    ...
    public HuestoneClusterConfiguration(int p_160772_, IntProvider p_160773_, IntProvider p_160774_, int p_160775_, int p_160776_, IntProvider p_160777_, FloatProvider p_160778_, FloatProvider p_160779_, float p_160780_, int p_160781_, int p_160782_) {
